...
export default function TelegramChatView() {
  ...
  const messageGrid = {
    ...
    text: "Check out this image!",
    time: "10:15 AM",
    images: ["/image1.jpg", "/image2.jpg", "/image3.jpg", "/image4.jpg"], // Replace with your image URL
  };
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Tomorrow batch 1 Python prac at 9.15 in lab 3 (318)",
      sent: false,
      time: "9:26 AM",
    ...
    {
      id: 2,
      text: "Tomorrow batch 2 having DS practical at 9.15 in lab2(318)",
      sent: false,
      time: "11:48 AM",
      date: new Date(2024, 8, 16),
      sender: "Avinash",
    ...
    {
      id: 3,
      text: "Tomorrow batch 3 having DS practical at 9.15 in jr.lab",
      sent: false,
      time: "11:50 AM",
      date: new Date(2024, 8, 16),
      sender: "Avinash",
    ...
    {
      id: 4,
      text: "As scheduled by the teacher, Fyds students report straight for their practical.",
      sent: false,
      time: "11:50 AM",
      date: new Date(2024, 8, 16),
      sender: "Avinash",
    ...
    {
      id: 5,
      text: "Batch 3 come in jr lab room no. 320",
      sent: false,
      time: "9:11 AM",
    ...
    {
      id: 6,
      text: "As Rohan sir has mentioned about the presentation this msg is for the ones who are not aware Y'all have to make a grp of 4 (by choice) And present your topic",
      sent: false,
      time: "9:30 AM",
      date: new Date(2024, 8, 17),
      sender: "Avinash",
    ...
    {
      id: 7,
      text: "Tommrow  after lecture stay in class i will come for  i card distribution",
      sent: false,
      time: "12:46 PM",
    ...
    {
      id: 9,
      text: "https://forms.gle/dSVEAwkTEzGDABD 19",
      sent: false,
      time: "10:18 AM",
      date: new Date(2024, 8, 19),
      sender: "Avinash",
    ...
    {
      id: 9,
      text: "Mathmatics bridge course link above",
      sent: false,
      time: "10:18 AM",
      date: new Date(2024, 8, 19),
      sender: "Avinash",
    ...
    {
      id: 12,
      text: "Students will have tomorrow off since all staff members will be attending meetings with higher authorities. So tomorrow is no college.",
      sent: false,
      time: "9:15 PM",
      date: new Date(2024, 8, 20),
      sender: "Avinash",
    ...
    {
      id: 13,
      text: "On monday fyds python batch 2 practical at 9.15am",
      sent: false,
      time: "2:20 PM",
    ...
    {
      id: 14,
      text: "On monday fyds python batch 3 practical at 9.15am",
      sent: false,
      time: "10:10 AM",
    ...
    {
      id: 15,
      text: "Today batch 3  having DS practical from 10 am in lab 3",
      sent: false,
      time: "8:24 AM",
    ...
    {
      id: 16,
      text: "All students Come to 3rd floor lab",
      sent: false,
      time: "9:11 AM",
    ...
    {
      id: 17,
      text: "On Monday FYDS batch 1 having DS practical at 9.15 am",
      sent: false,
      time: "11:50 AM",
      date: new Date(2024, 8, 28),
      sender: "Avinash",
    ...
    {
      id: 18,
      text: "Batch 1 submit ur Python prac file on Thursday at 9.15",
      sent: false,
      time: "11:50 AM",
    ...
    {
      id: 19,
      text: "Fyds batch 1 students ur writeups are not up to the mark You will have to rewrite the files again",
      sent: false,
      time: "10:23 AM",
    ...
    {
      id: 20,
      text: "Notice for the camp in Mahabareshwar",
      sent: false,
      time: "9:11 AM",
  ...
  const checkDayChange = (currentMessage, previousMessage) => {
    ...
    return (
      dayjs(currentMessage.date).format("YYYY-MM-DD") !==
      dayjs(previousMessage.date).format("YYYY-MM-DD")
    );
  };
  ...
  return (
    ...
    >
      {/* Header */}
      <header
        className={`w-full px-4 py-2 flex items-center fixed top-0 backdrop-blur-md ${
      ...
      >
        ...
        <div
          className={`h-10 w-10 mr-4 rounded-full flex items-center justify-center text-white text-xl font-bold ${getGradientByIndex(
            0
          )}`}
        >
          {contact.name
          ...
          return (
            <div key={msg.id}>
              ...
              >
                {!msg.sent && (
                  <div
                    className={`h-10 w-10 rounded-full mr-2 bg-gradient-to-r from-orange-300 via-orange-400 to-orange-500 flex items-center justify-center`}
                  >
                ...
                <div
                  className={`max-w-[77%] rounded-lg p-2 ${
                    msg.sent ? "bg-blue-500 text-white" : "bg-zinc-800"
                  }`}
                >
                  <p className="font-bold text-orange-400">{msg.sender}</p>
                  <p>{msg.text}</p>
                  <div
                    className={`text-xs mt-0 w-full justify-end flex ${
                      msg.sent ? "text-blue-100" : "text-gray-400"
                    }`}
                  >
                    {msg.time}
      ...
      {/* Message Input */}
      <div
        className={`w-full px-4 py-2 flex items-center justify-center fixed bottom-0 backdrop-blur-xl ${
          isDarkMode ? "bg-zinc-900 text-white" : "bg-blue-500 text-white"
        }`}
      >
        <h1 className="ml-2 text-gray-500 text-center">
